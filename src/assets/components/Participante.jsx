                  ...
                  <div style={styles.grid2}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        min="0"
                        max="100"
                        value={respuestas[index]?.importancia_impacto || ''}
                        onChange={e => handleChange(index, 'importancia_impacto', e.target.value)}
                      />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        min="0"
                        max="100"
                        value={respuestas[index]?.importancia_frecuencia || ''}
